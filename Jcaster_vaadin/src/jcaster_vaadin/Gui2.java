    ...
    protected void setupRecording() {
		...
		try {
			...
			if(selectedAudioVideoType.equalsIgnoreCase(AudioVideoTypes.AUDIO_AND_VIDEO)) {
				settings = new CaptureSettings(AudioVideoTypes.AUDIO_AND_VIDEO, getSaveLocation(), getFilename(), getVideoFormat(), captureDuration);
			} else if(selectedAudioVideoType.equalsIgnoreCase(AudioVideoTypes.VIDEO)) {
				settings = new CaptureSettings(AudioVideoTypes.VIDEO, getSaveLocation(), getFilename(), getVideoFormat(), captureDuration);
			} else if(selectedAudioVideoType.equalsIgnoreCase(AudioVideoTypes.AUDIO)) {
				settings = new CaptureSettings(AudioVideoTypes.AUDIO, getSaveLocation(), getFilename(), getVideoFormat(), captureDuration);
			}
